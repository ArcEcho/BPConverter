...
class FReferenceCollectorArchiveExt : public FArchiveUObject
{
...
public:
	...
	FReferenceCollectorArchiveExt(const UObject* InSerializingObject, FReferenceCollector& InCollector)
	...
	FArchive& operator<<(FObjectPtr& Object)
	{
...
/** Helper class for setting and resetting attributes on the FReferenceCollectorArchiveExt */
class FVerySlowReferenceCollectorArchiveScopeExt
{
	FReferenceCollectorArchiveExt& Archive;
	const UObject* OldSerializingObject;
	FProperty* OldSerializedProperty;
	const UObject* OldSerializedDataContainer;

public:
	FVerySlowReferenceCollectorArchiveScopeExt(FReferenceCollectorArchiveExt& InArchive, const UObject* InSerializingObject, FProperty* InSerializedProperty = nullptr, const UObject* InSerializedDataContainer = nullptr)
		: Archive(InArchive)
	...
	~FVerySlowReferenceCollectorArchiveScopeExt()
	{
	...
	FReferenceCollectorArchiveExt& GetArchive()
	{
		return Archive;
	}
};

class FGatherConvertedClassDependenciesArchive : public FReferenceCollectorArchiveExt
{
public:
	FGatherConvertedClassDependenciesArchive(UObject* InSerializingObject, FReferenceCollector& InCollector)
		: FReferenceCollectorArchiveExt(InSerializingObject, InCollector)
	{
		ArIsObjectReferenceCollector = true;
...
struct FGatherConvertedClassDependenciesHelperBase : public FReferenceCollector
{
	...
	{
		{
			FVerySlowReferenceCollectorArchiveScopeExt CollectorScope(Archive, Object, nullptr);
	...
	, NativizationOptions(InNativizationOptions)
{
	...
	auto GatherRequiredModules = [this](const TSet<UField*>& Fields)
	{
		for (UField* Field : Fields)
		{
			...
			{
				RequiredModuleNames.Add(TSoftObjectPtr<UPackage>(Package));
			}
		}
	};
...
class FFieldCollectorArchive : public FArchiveUObject
{
...
public:
	...
	virtual FArchiveUObject& operator << (FField*& InField) override
	{
