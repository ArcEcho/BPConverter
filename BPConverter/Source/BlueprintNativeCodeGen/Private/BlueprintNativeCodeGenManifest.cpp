...
namespace BlueprintNativeCodeGenManifestImpl
{
	 ...
	 */
	static bool GatherModuleDependencies(const UObject* AssetObj, TArray<TObjectPtr<UPackage>>& DependenciesOut);
...
//------------------------------------------------------------------------------
static bool BlueprintNativeCodeGenManifestImpl::GatherModuleDependencies(const UObject* AssetObj, TArray<TObjectPtr<UPackage>>& DependenciesOut)
{
